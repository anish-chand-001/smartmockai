        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-10 mb-28">
            {[
              ...
              >
                <div
                  className="absolute bg-white -top-8 left-1/2 -translate-x-1/2 border  border-green-500 text-green-600 w-16 h-16 rounded-2xl
               flex items-center justify-center shadow-lg"
                ...
                <div className="pt-10 text-center ">
                  ...
                  <h3 className="font-semiblod mb-3 text-lg">{item.title}</h3>
              ...
              {[
                {
                  ...
                  description:
                    "Score communication, technical accuracy, and confidence metrics.",
                },

                {
                  ...
                  description:
                    "Project specific question based on the uploaded resume",
                },
                {
                  image: pdfImg,
                  ...
                  description:
                    "Export detailed performance breakdowns and shareable feedback records.",
                },
                {
                  image: analyticsImg,
                ...
                <motion.div
                  ...
                  key={index}
                  className="bg-whtie border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all"
                >
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="w-full md:w-1/2 ">
                      <div
                        className="bg-green-50 text-green-600w w-12 h-12 rounded-xl 
          ...
          <div className="mb-32">
            <motion.h2
              ...
              className="text-4xl  font-semibold text-center mb-16 "
            >
              Mutltiple Interview <span className="text-green-600 ">Modes</span>
            </motion.h2>
            <div className="grid md:grid-cols-2 gap-10 ">
              {[
                {
                  ...
                  description:
                    "Experience behavioral questions designed to test cultural fit and soft skills.",
                },
                {
                  image: techlImg,
                  icon: <BsCpu size={20} />,
                  ...
                  description:
                    "Deep dive into domain-specific queries, coding logic, and system design.",
                },
                {
                  image: confidenceImg,
                  ...
                  description:
                    "Analyze tone, pacing, and speech clarity for an impactful presentation.",
                },
                {
                  image: creditImg,
                  ...
                  description:
                    "Keep track of mock interview credits and seamless subscription usage.",
                },
              ].map((mode, index) => (
                <motion.div
                  initial={{ opacity: 0, y: 30 }}
